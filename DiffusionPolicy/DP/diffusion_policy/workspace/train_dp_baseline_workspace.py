...
class TrainDiffusionUnetHybridWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        dataset = dp_baseline_dataset(cfg.task.dataset.zarr_path, cfg.task.dataset.traj_num, cfg.task.dataset.train_mask_start,
                                            cfg.task.dataset.train_mask_end, cfg.task.dataset.val_mask_start, cfg.task.dataset.val_mask_end,
                                            cfg.velocity_as_obs, cfg.finalgrasp_as_obs, pad_before=1, pad_after=7, horizon=16)
